...
## Entrada 1:
**Fecha:** 07/04/2026
**Módulo estudiado:** Test Syllabus, enfasis en preguntas tipo K2 y K3.

## ¿Qué he aprendido hoy?

* [x] Entendí la diferencia entre Cobertura de: sentencia, condición, decisión.
* [x] Entendí el enfoque RAD (Rapid Application Development)
* [x] Entendí diferencias entre TMMi y TPI y sus aplicación ideal
* [x] Revisé los tipos de pruebas: Caja Negra vs Blanco y su aplicación ideal.
* [x] Entendí algunos sistemas de "Cobertura avanzada".

## Estado del aprendizaje

En progreso - Preparando el examen CTFL. 70% aciertos :D
